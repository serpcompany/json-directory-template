...
So, in short, XGBoost uses decision trees as its players and gradient boosting as its coach to create a strong, accurate prediction model that can take on any opponent. [Extreme Gradient Boosting](/posts/extreme-gradient-boosting/)
