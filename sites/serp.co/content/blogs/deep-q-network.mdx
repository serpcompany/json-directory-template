...
In short, DQN uses a neural network to help make optimal decisions in complicated situations by learning and approximating the value of each possible action. [Deep Q Network](/posts/deep-q-network/)
