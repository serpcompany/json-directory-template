...
Try LOESS out on your own data to see what patterns and surprises it reveals! [Locally Estimated Scatterplot Smoothing](/posts/locally-estimated-scatterplot-smoothing/)
