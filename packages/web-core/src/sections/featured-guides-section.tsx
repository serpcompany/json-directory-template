...
export function FeaturedGuidesSection({ guides, slots }: FeaturedGuidesSectionProps) {
  if (guides.length === 0) {
    return null
  }
  ...
  return (
    ...
    >
      <DirectoryFeatureGrid className="sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 3xl:grid-cols-5 4xl:grid-cols-6">
        {guides.map(guide => (
