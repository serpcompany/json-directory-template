...
import { searchIndexSchema, type SearchIndexEntry } from '../apps/web/lib/search-index.ts'
...
function writeSearchIndex(outputPath: string, searchIndex: SearchIndexEntry[]): void {
...
export function main(): void {
  ...
  const listingBasePath = process.env.LISTING_ROUTE_BASE_PATH || 'websites'
